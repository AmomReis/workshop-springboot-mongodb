package com.amomdev.workshopmongo.config;

import com.amomdev.workshopmongo.domain.Post;
import com.amomdev.workshopmongo.domain.User;
import com.amomdev.workshopmongo.dto.AuthorDTO;
import com.amomdev.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viajem!", Instant.now(), new AuthorDTO(alex));
